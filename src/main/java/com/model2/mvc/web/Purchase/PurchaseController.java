...
//		purchase.setBuyer(user);
		...
		model.addAttribute("fileNames", product.getFileName().split("%"));
		return "forward:/purchase/testAddPurchaseView.jsp";
	}
	...
	public String addPurchase(HttpSession session, @ModelAttribute Purchase purchase , @RequestParam("prodNo") int prodNo, Model model) {
		...
		productService.updateProductStock((product.getStock() - purchase.getPurchaseStock()), product.getProdNo());
		purchaseService.addPurchase(purchase);
		
		model.addAttribute("purchase", purchase);
		return "/purchase/testAddPurchaseResultView.jsp";
	}
	...
	public String getPurchase(@RequestParam("tranNo") int tranNo, Model model) {
		...
		return "forward:/purchase/testGetPurchaseView.jsp";
	}
	...
	public String listPurchase(HttpSession session, @RequestParam(value="currentPage", defaultValue = "1") int currentPage
		...
		return "/purchase/testListPurchaseView.jsp";
	}
	...
	public String updatePurchaseView(@RequestParam("tranNo") int tranNo, Model model) {
		...
		return "forward:/purchase/testUpdatePurchaseView.jsp";
	}
