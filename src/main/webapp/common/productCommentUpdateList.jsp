...
<body>
	...
	<form method="post" action="/addCommentAction.do?prodNo=${product.prodNo}">
		<div>수정하기</div>
...
<!-- 		<td class="ct_list_b" width="100">수정</td>	
	...
	<c:forEach var="comment" items="${commentList}">
		...
		<td align="center">${comment.commentUser.userId}</td>
		<td></td>
...
<%-- 		<td align="center">
		...
		<td align="center">
			<c:choose>
				<c:when test="${user.userId == comment.commentUser.userId}">
