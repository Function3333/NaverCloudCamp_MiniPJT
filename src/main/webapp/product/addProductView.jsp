...
function fncAddProduct(){
	...
	$("form[name=detailForm]").attr("action", "/product/addProduct").submit();
}
...
$(function() {
	...
	$("#calendar").on("click", function() {
		show_calendar('document.detailForm.manuDate', $("form input[name=manuDate]").val());
	})
});
</script>
</head>
...
<form name="detailForm" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 13px;">
	...
	<tr>
		...
		<td class="ct_write01">
			<input type="text" name="prodDetail" class="ct_input_g" 
						style="width: 100px; height: 19px" maxLength="200" minLength="3"/>
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		<td width="104" class="ct_write">
			제조일자 <img src="/images/ct_icon_red.gif" name="calendar" width="3" height="3" align="absmiddle"/>
		</td>
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
		<div id="calendar">
