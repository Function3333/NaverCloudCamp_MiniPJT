...
$(function() {
	$("#checkBtn").on("click", function() {
		alert("button[name=checkBtn]");
		$(location).attr("href", "/product/listProduct?menu=manage");
	})
	
	$("#additionalEnrollBtn").on("click", function() {
		alert("button[name=additionalEnrollBtn]");
		...
		<td align="right">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>					
					...
					<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top:3px;">
						<button type="button" id="additionalEnrollBtn">추가등록</button>
					</td>
					<td width="14" height="23">
						<img src="/images/ct_btnbg03.gif" width="14" height="23"/>
					</td>
