...
<script type="text/javascript">
	...
	function fncAddProduct(){
		...
		var detail = $("form input[name=prodDetail]").val();
		var manuDate = $("form input[name=manuDate]").val();
		var price = $("form input[name=price]").val();
		...
		$("form[name=detailForm]").attr("action", "/product/updateProduct").submit();
	}
