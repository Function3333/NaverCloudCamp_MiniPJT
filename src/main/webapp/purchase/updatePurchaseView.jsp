...
<script type="text/javascript">
	$(function() {
		$("#calandar").on("click", function() {
			show_calendar('document.updatePurchase.dlvyDate', $("input[name=dlvyDate]").val());
		});
		...
		$("td.ct_btn01:contains('수정')").on("click", function() {
			$("form[name=updatePurchase]").attr("action", "/purchase/updatePurchase").submit();
		});
	})
</script>
...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<input type="hidden" name="purchaseNo" value="${purchase.tranNo}">
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
