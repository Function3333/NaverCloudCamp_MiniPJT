...
<%-- 			<select name="searchCondition" class="ct_input_g" style="width:80px">
	...
	<div align="right">
		<a href="/product/listProduct?searchCondition=0&searchKeyword=${search.searchKeyword}">낮은 가격순</a>
		<a href="/product/listProduct?searchCondition=1&searchKeyword=${search.searchKeyword}">높은 가격순</a>
		<a href="/product/listProduct?searchCondition=2&searchKeyword=${search.searchKeyword}">최신순</a>
		<a href="/product/listProduct?searchCondition=3&searchKeyword=${search.searchKeyword}">조회순</a>
