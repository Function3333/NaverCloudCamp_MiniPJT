...
public class ProductForm {
	...
	public Product formToVO(ProductForm form) {
		...
		product.setFileName(createImageName(form.getFileName()));
		
		System.out.println("ProductForm.getFileName = " + product.getFileName());
		return product;
	}
	
	public String createImageName(List<MultipartFile> multipartFiles) {
