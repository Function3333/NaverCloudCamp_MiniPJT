...
public class ProductController {
	...
	public String addProduct(@ModelAttribute ProductForm productForm, Model model) throws Exception {
		...
		for(MultipartFile image : images) {
			File file = new File(imagePath, image.getOriginalFilename());
			image.transferTo(file);
		}
		
		Product product = productForm.formToVO(productForm);
	...
	public String updateProduct(@ModelAttribute ProductForm productForm, Model model) {
		...
		if(findProduct.getProTranCode() == null) {
			...
			findProduct.setFileName(productForm.createImageName(productForm.getFileName()));
...
//		System.out.println("[Product(Post) Controller init]");
//		
