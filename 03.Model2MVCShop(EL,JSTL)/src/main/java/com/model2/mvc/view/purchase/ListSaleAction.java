...
public class ListSaleAction extends Action{
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		System.out.println("ListUserAction search.getSearchKeyword = " + search.getSearchKeyword());
		System.out.println("ListUserAction search.getSearchCondition = " + search.getSearchCondition());
