...
<table width="100%" border="0" cellspacing="0" cellpadding="0"	style="margin-top: 10px;">
	...
	<c:forEach var="vo" items="${list}">
		...
		<td align="center">
			<a href="/getPurchase.do?tranNo=${vo.tranNo}">${vo.purchaseProd.prodName}</a>
		</td>
		<td></td>
		...
		<td align="center">${vo.buyer.userName}</td>
		<td></td>
		...
		<td align="center">현재
			...
			<c:if test="${fn:trim(vo.tranCode) eq '2'}">
				${'배송중'}
				<a href="/updateTranCode.do?tranNo=${vo.tranNo}&tranCode=3">물건수령</a>
			</c:if>
