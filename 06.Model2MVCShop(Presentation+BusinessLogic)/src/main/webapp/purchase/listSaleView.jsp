...
<div align="right">
		<a href="/listSale.do?searchCondition=0&searchKeyword=${search.searchKeyword}">낮은 가격순</a>
		<a href="/listSale.do?searchCondition=1&searchKeyword=${search.searchKeyword}">높은 가격순</a>
		<a href="/listSale.do?searchCondition=2&searchKeyword=${search.searchKeyword}">최신순</a>
		<a href="/listSale.do?searchCondition=3&searchKeyword=${search.searchKeyword}">조회순</a>
